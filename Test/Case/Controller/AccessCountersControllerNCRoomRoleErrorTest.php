<?php
/**
 * AccessCountersControllerNCRoomRoleErrorTest Test Case
 *
 ...
 */
class AccessCountersControllerNCRoomRoleErrorTest extends ControllerTestCase {
 ...
 */
	public function login() {
		// AccessCountersControllerのモック生成
